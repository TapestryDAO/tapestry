...
export const TapestryCanvas: FC = (props) => {
    ...
    const renderPlace = (time: number) => {
        // put image data
        const shouldDraw =
            previousTimeRef.current === null || time - previousTimeRef.current > DRAW_RATE_MS;
    ...
    const onDrop = async (event: DragEvent) => {
        ...
        let readyForUpdate = tokenResult.gameplayTokenMetaAcct.data.update_allowed_slot.lte(
