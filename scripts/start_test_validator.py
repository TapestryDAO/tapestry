...
PROGRAMS = [
    (
        "tapestry11111111111111111111111111111111111",
        CARGO_DEPLOY_DIR / "solana_place.so",
    ),
    (
        "metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s",
        MPL_DEPLOY_DIR / "mpl_token_metadata.so ",
    ),
    ("auctxRXPeJoc4817jDhf4HbjnhEcr1cCXenosMhK5R8", MPL_DEPLOY_DIR / "mpl_auction.so"),
    (
        "hausS13jsjafwWwGqZTUQRmWyvyxn9EQpqMwV1PBBmk",
        MPL_DEPLOY_DIR / "mpl_auction_house.so",
    ),
    (
        "vau1zxA2LbssAUEF7Gpw91zMM1LvXrvpzJtmZ58rPsn",
        MPL_DEPLOY_DIR / "mpl_token_vault.so",
    ),
]
